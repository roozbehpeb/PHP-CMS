...
<div class="col-sm-10   p-2 ">
    <form action="admin_category/delete_attribute/<?= $Category_Info['id_category'] ?>/<?= @$attribute_Info['id_attribute'] ?>"
          method="post">
            ...
            <?php foreach ($get_attribute as $row) { ?>
                <tr>
                    ...
                    <td class="text-center ">
                        <?php if ($get_attribute[0]['ID_parent'] == 0) { ?>
                            <a class="add-pluse" title="diabled by admin" onclick="return false;"
                               href="#">
