    ...
    <div class="row p-2 ">
        ...
        <div class="col-12 col-sm-6 col-md-6 col-lg-2">
            <div class=" row justify-content-around">
                ...
                <span type="button" class="dropdown-toggle login-panel  " data-bs-toggle="dropdown">
                        <i class="fas fa-user custom-login"></i>
                </span>
                                        <div class="dropdown-menu text-center rounded p-2 position-absolute custom-menu-panel custom-menu-panel2">
                                            <div class="dropdown-divider "></div>
                                            <div class="text-left pr-2">
                                                ...
                                                <a href="<?php URL ?>admin_dashboard">
                                                    <button class="dropdown-item custom-profile-item  border-0">
                                                        <i class="fas fa-user"></i>dashboard
                                                    </button>
                                                </a>
                                                <a href="<?php URL ?>Panel/logout">
                                                    <button class="dropdown-item custom-profile-item  border-0">
                                                        <i class="fas fa-calendar-check"></i>log out
                                                    </button>
                                                </a>
                                            </div>
                ...
                <div class="col-lg-9 col_basket2">
                                ...
                                <div class="row data-item">
                                    ...
                                    <div class="col-12 col-md col-lg pt-2  ">
                                        ...
                                        <ul class="list-group px-0 border-0 custom-sub-menu-digital-1" id="">
                                            ...
                                            <li class="ffeiefef  border-0"><span class="menu-font-title"> لوازم جانبی گوشی</span>
                                                <i
                                                        class="fas fa-angle-left "></i></li>

                                            <li class="ffeiefef  border-0">
                                        ...
                                        <ul class="list-group px-0 border-0 custom-sub-menu-digital-1">
                                            <li class="ffeiefef  border-0"><span class="menu-font-title"> گوشی موبایل</span>
                                                <i
                                                        class="fas fa-angle-left "></i></li>
                                            <li class="ffeiefef  border-0">
                                                <a href="#">سامسونگ</a></li>
